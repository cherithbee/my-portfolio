...
export default function Navbar() {
  ...
  return (
  <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-full flex justify-center px-4">
    <div className="flex flex-row md:flex-col items-center border border-black/[0.1] dark:border-white/10 shadow-2xl p-2 rounded-[3rem] backdrop-blur-2xl transition-all duration-500 
      /* FIX: Prevents the bar from being wider than your phone screen */
      max-w-full md:max-w-none w-auto overflow-hidden">
      ...
      {/* SWIPEABLE LINK CONTAINER - Added flex-nowrap and overflow-x-auto */}
